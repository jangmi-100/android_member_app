...
import mincheol.memberapplication.helper.DatabaseHelper;
...
//    private DatabaseHelper databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //회원가입 이벤트 처리
        // main Activity에서 네트워크 작업시 NetworkOnMainThreadException 발생!
        // 즉, 메인쓰레드에서 네트워크 작업은 기본적으로 금지되어 있음
        // 특정 액티비티가 네트워크를 독점적으로 점유하는 것을 방지
        // 비동기 처리를 이용해서 코드를 작성해야 함
        // >> AsyncTask, ExcutorService, Coroutines (코틀린 - 추천!)
    ...
    private class RegisterUserTask extends AsyncTask<String, Void,Boolean> {
        ...
        protected void onPostExecute(Boolean success){
            if(success==null){//아이디가 중복이면
                ...
                Toast.makeText(MainActivity.this,"😱회원가입 실패! 다시 시도하세요!😱",Toast.LENGTH_SHORT).show();
            }
        }
    }
}
