...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //데이터베이스 초기화 변수
    //device explorer >> data >> 앱 패키지 >>databases
    ...
    public void onCreate(SQLiteDatabase db) {
        String SQL = "create table member ("+
                ...
                "passwd varchar(18) not null, name varchar(18) not null,"+
                "email text not null, regdate datetime default current_timestamp"+
                ")";
        db.execSQL(SQL);
    }
    ...
    public boolean loginUser(String userid, String passwd){
        ...
        //쿼리 실행
        //내가 만든 쿼리문
        //Cursor cur = db.query("member",new String[]{"mno"}, "userid=? and passwd=?",new String[]{userid,passwd},null,null,null);
